...
class SundbAgent : DatabaseAgent {
    ...
    override fun connect(params: ConnectParams) {
        ...
        val url = "jdbc:sundb://${params.host}:${params.port}/${params.database}"
    ...
    override fun listSchemas(): List<String> {
        // In SunDB, schemas and databases are the same concept
